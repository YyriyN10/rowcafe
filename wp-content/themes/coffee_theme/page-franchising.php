                        ...
                        <div class="top-slider__slide-box"
                            ...
                            <div class="video-section__holder">
                                ...
                                <a href="#" class="video-section__btn finance-button">
                                    <span><?php echo $slide['btn_text']; ?></span>
                                </a>
                            </div>
                        </div>
                    </div>
...
if (have_rows('flexible_content')) {
    while (have_rows('flexible_content')) {
        the_row();
        get_template_part('template-parts/franchising/section', get_row_layout());
    }
}
wp_reset_postdata();
?>
